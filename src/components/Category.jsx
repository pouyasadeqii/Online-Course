...
const Category = () => {
  return (
    <div className="px-6 md:px-32 mb-20">
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-8">
        <div className="w-[255px] shadow-lg bg-white rounded-lg p-3 flex gap-6">
          <img src={uxResearcher} alt="uxresearcher" className="w-20 h-14" />
        ...
        <div className="w-[255px] shadow-lg bg-white rounded-lg p-3 flex gap-6">
          <img src={userInterface} alt="uxresearcher" className="w-20 h-14" />
          <div className="flex flex-col gap-2">
            <span className="font-semibold text-myblack text-sm">
              User Interface
            </span>
        ...
        <div className="w-[255px] shadow-lg bg-white rounded-lg p-3 flex gap-6">
          <img src={userExperience} alt="uxresearcher" className="w-20 h-14" />
          <div className="flex flex-col gap-2">
            <span className="font-semibold text-myblack text-sm">
              User Experience
            </span>
        ...
        <div className="w-[255px] shadow-lg bg-white rounded-lg p-3 flex gap-6">
          <img src={webDesign} alt="uxresearcher" className="w-20 h-14" />
          <div className="flex flex-col gap-2">
            <span className="font-semibold text-myblack text-sm">
              Web Design
            </span>
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-8">
        ...
        <div className="w-[255px] shadow-lg bg-white rounded-lg p-3 flex gap-6">
          <img src={dataScience} alt="uxresearcher" className="w-20 h-14" />
          <div className="flex flex-col gap-2">
            <span className="font-semibold text-myblack text-sm">
              Data Science
            </span>
        ...
        <div className="w-[255px] shadow-lg bg-white rounded-lg p-3 flex gap-6">
          <img src={graphicDesign} alt="uxresearcher" className="w-20 h-14" />
          <div className="flex flex-col gap-2">
            <span className="font-semibold text-myblack text-sm">
              Graphic Design
            </span>
        ...
        <div className="w-[255px] shadow-lg bg-white rounded-lg p-3 flex gap-6">
          <img src={contentWritting} alt="uxresearcher" className="w-20 h-14" />
          <div className="flex flex-col gap-2">
            <span className="font-semibold text-myblack text-sm">
              Content Writting
            </span>
